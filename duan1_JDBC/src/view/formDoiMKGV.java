 ...
 * @author Dell
 */
public class formDoiMKGV extends javax.swing.JFrame {

    private String maGV;
    private GiangVienService gvService = new GiangVienImpl();
    ...
    private void btnDoiMKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoiMKActionPerformed
        ...
        if (validatePass(oldPass, newPass, newPassAgain)) {
            if (gvService.updatePassGv(newPass, maGV)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        menuGiangVien m = new menuGiangVien();
        m.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formDoiMKGV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formDoiMKGV().setVisible(true);
            }
        });
    }
